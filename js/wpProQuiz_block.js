    ...
    function createSelectElment(el, props, quizner, withServerRender) {
        return el(
            ...
            withServerRender ? el(ServerSideRender, {
                key: 'editable',
                block: 'Bestwebsite-Pro-Quiz/quiz',
                attributes: props.attributes
            }) : null
        )
    }

    wp.blocks.registerBlockType('Bestwebsite-Pro-Quiz/quiz', {
        title: 'Bestwebsite-Pro-Quiz',
        icon: 'universal-access-alt',
        category: 'common',
        example: {},
        edit: withSelect(function (select) {
            var attr = select('core/blocks').getBlockType('Bestwebsite-Pro-Quiz/quiz').attributes;
