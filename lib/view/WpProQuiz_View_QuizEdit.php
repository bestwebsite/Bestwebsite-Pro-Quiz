...
class WpProQuiz_View_QuizEdit extends WpProQuiz_View_View
{
        ...
        <div class="wrap wpProQuiz_quizEdit">
            ...
            <form method="post"
                ...
                <a style="float: left;" class="button-secondary" href="<?php echo admin_url('admin.php?page=wpProQuiz'); ?>">
                    <?php _e('back to overview', 'Bestwebsite-Pro-Quiz'); ?>
                </a>
                ...
                <div style="float: right;">
                    ...
                    <input type="submit" name="templateLoad" value="<?php _e('load template', 'Bestwebsite-Pro-Quiz'); ?>"
                ...
                <div id="poststuff">
                    ...
                    <div style="float: left;">
                        <input type="submit" name="submit" class="button-primary" id="wpProQuiz_save"
                               value="<?php _e('Save', 'Bestwebsite-Pro-Quiz'); ?>">
                    </div>
                    <div style="float: right;">
                        <input type="text" placeholder="<?php _e('template name', 'Bestwebsite-Pro-Quiz'); ?>"
                               class="regular-text" name="templateName" style="border: 1px solid rgb(255, 134, 134);">
                        <select name="templateSaveList">
                            <option value="0">=== <?php _e('Create new template', 'Bestwebsite-Pro-Quiz'); ?> ===</option>
                            <?php
                            foreach ($this->templates as $template) {
                                echo '<option value="', $template->getTemplateId(), '">', esc_html($template->getName()), '</option>';
                            }
                        ...
                        <input type="submit" name="template" class="button-primary" id="wpProQuiz_saveTemplate"
                               value="<?php _e('Save as template', 'Bestwebsite-Pro-Quiz'); ?>">
                    </div>
                    <div style="clear: both;"></div>
                </div>
            </form>
    ...
    private function tabBar()
    {
        ...
        <div class="nav-tab-wrapper wpProQuiz-top-tab-wrapper">
            <a href="#tabGeneral" data-tab="tabGeneral" class="nav-tab nav-tab-active"><?php _e('General', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabResult" data-tab="tabResult" class="nav-tab "><?php _e('Result', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabOptions" data-tab="tabOptions" class="nav-tab "><?php _e('Options', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabCustomFields" data-tab="tabCustomFields" class="nav-tab "><?php _e('Custom fields', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabLeaderboard" data-tab="tabLeaderboard" class="nav-tab "><?php _e('Leaderboard', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabEmailSettings" data-tab="tabEmailSettings" class="nav-tab "><?php _e('Email Settings', 'Bestwebsite-Pro-Quiz'); ?></a>
            <a href="#tabPlugins" data-tab="tabPlugins" class="nav-tab "><?php _e('Plugins', 'Bestwebsite-Pro-Quiz'); ?></a>
    ...
    private function postBoxOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Options', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide quiz title', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide title', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label for="title_hidden">
                                    ...
                                    <?php _e('Activate', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>

                                <p class="description">
                                    <?php _e('The title serves as quiz heading.', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Hide "Restart quiz" button', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide "Restart quiz" button', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide "View question" button', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide "View question" button', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display question randomly', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display question randomly', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display answers randomly', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display answers randomly', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Sort questions by category', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Sort questions by category', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Time limit', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Time limit', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label for="time_limit">
                                    <input type="number" min="0" class="small-text" id="time_limit"
                                           value="<?php echo $this->quiz->getTimeLimit(); ?>"
                                           name="timeLimit"> <?php _e('Seconds', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>

                                <p class="description">
                                    <?php _e('0 = no limit', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Statistics', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistics', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr id="statistics_ip_lock_tr" style="display: none;">
                        <th scope="row">
                            <?php _e('Statistics IP-lock', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistics IP-lock', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Execute quiz only once', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>

                                <legend class="screen-reader-text">
                                    <span><?php _e('Execute quiz only once', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                ...
                                <div id="wpProQuiz_quiz_run_once_type"
                                    ...
                                    <?php _e('This option applies to:', 'Bestwebsite-Pro-Quiz');
                                    ...
                                    <label>
                                        ...
                                        <?php _e('all users', 'Bestwebsite-Pro-Quiz'); ?>
                                    </label>
                                    <label>
                                        <input name="quizRunOnceType" type="radio"
                                               value="2" <?php echo ($quizRunOnceType == 2) ? 'checked="checked"' : ''; ?>>
                                        <?php _e('registered useres only', 'Bestwebsite-Pro-Quiz'); ?>
                                    </label>
                                    <label>
                                        <input name="quizRunOnceType" type="radio"
                                               value="3" <?php echo ($quizRunOnceType == 3) ? 'checked="checked"' : ''; ?>>
                                        <?php _e('anonymous users only', 'Bestwebsite-Pro-Quiz'); ?>
                                    </label>
                                    ...
                                    <div id="wpProQuiz_quiz_run_once_cookie" style="margin-top: 10px;">
                                        <label>
                                            ...
                                            <?php _e('user identification by cookie', 'Bestwebsite-Pro-Quiz'); ?>
                                        </label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show only specific number of questions', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                                <span><?php _e('Show only specific number of questions',
                                                        'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div id="wpProQuiz_showMaxBox" style="display: none;">
                                    ...
                                    <label>
                                        ...
                                        <?php _e('in percent', 'Bestwebsite-Pro-Quiz'); ?>
                                    </label>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Prerequisites', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Prerequisites', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Question overview', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Question overview', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="wpProQuiz_demoBox">
                                    <?php _e('Question overview', 'Bestwebsite-Pro-Quiz'); ?>: <a
                                            href="#"><?php _e('Demo', 'Bestwebsite-Pro-Quiz'); ?></a>
                                ...
                                <div class="wpProQuiz_demoBox">
                                    <?php _e('Quiz-summary', 'Bestwebsite-Pro-Quiz'); ?>: <a
                                            href="#"><?php _e('Demo', 'Bestwebsite-Pro-Quiz'); ?></a>
                    ...
                    <tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
                        <th scope="row">
                            <?php _e('Quiz-summary', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Quiz-summary', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                           name="quizSummaryHide" <?php $this->checked($this->quiz->isQuizSummaryHide()); ?>>
                                    <?php _e('Deactivate', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                    ...
                    <tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
                        <th scope="row">
                            <?php _e('Skip question', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Skip question', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <!--
							<tr>
								<th scope="row">
									<?php _e('Admin e-mail notification', 'Bestwebsite-Pro-Quiz'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('Admin e-mail notification', 'Bestwebsite-Pro-Quiz'); ?></span>
										</legend>
										<label>
                        ...
                        WpProQuiz_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER); ?>>
											<?php _e('for registered users only', 'Bestwebsite-Pro-Quiz'); ?>
										</label>
										<label>
                        ...
                        WpProQuiz_Model_Quiz::QUIZ_EMAIL_NOTE_ALL); ?>>
											<?php _e('for all users', 'Bestwebsite-Pro-Quiz'); ?>
										</label>
										<p class="description">
                        ...
                        'Bestwebsite-Pro-Quiz'); ?>
							...
							<tr>
								<th scope="row">
									<?php _e('User e-mail notification', 'Bestwebsite-Pro-Quiz'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('User e-mail notification', 'Bestwebsite-Pro-Quiz'); ?></span>
										</legend>
										<label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Autostart', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Autostart', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
    ...
    private function postBoxResult()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Results text', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(optional)',
                    'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <div style="padding-top: 10px; padding-bottom: 10px;">
                    <label for="wpProQuiz_resultGradeEnabled">
                        <?php _e('Activate graduation', 'Bestwebsite-Pro-Quiz'); ?>
                ...
                <div style="display: none;" id="resultGrade">
                    <div>
                        <strong><?php _e('Hint:', 'Bestwebsite-Pro-Quiz'); ?></strong>
                        <ul style="list-style-type: square; padding: 5px; margin-left: 20px; margin-top: 0;">
                            <li><?php _e('Maximal 15 levels', 'Bestwebsite-Pro-Quiz'); ?></li>
                            <li>
                            ...
                            <li><?php _e('Values can also be mixed up', 'Bestwebsite-Pro-Quiz'); ?></li>
                    ...
                    <div>
                                ...
                                if ($this->quiz->isResultGradeEnabled() && isset($resultText['text'][$i])) {
                                    ...
                                    <li style="padding: 5px; border: 1px dotted;">
                                        ...
                                        <div
                                            ...
                                            <?php _e('from:', 'Bestwebsite-Pro-Quiz'); ?> <input type="text"
                                                                                        name="resultTextGrade[prozent][]"
                                                                                        class="small-text"
                                                                                        value="<?php echo $resultText['prozent'][$i] ?>"> <?php _e('percent',
                                                'Bestwebsite-Pro-Quiz'); ?> <?php printf(__('(Will be displayed, when result-percent is >= <span class="resultProzent">%s</span>%%)',
                                                'Bestwebsite-Pro-Quiz'), $resultText['prozent'][$i]); ?>
                                            <input type="button" style="float: right;"
                                                   class="button-primary deleteResult"
                                                   value="<?php _e('Delete graduation', 'Bestwebsite-Pro-Quiz'); ?>">
                        ...
                        <input type="button" class="button-primary addResult"
                               value="<?php _e('Add graduation', 'Bestwebsite-Pro-Quiz'); ?>">
                    </div>
                </div>
                <div id="resultNormal">
                    <?php
                ...
                <h4><?php _e('Custom fields - Variables', 'Bestwebsite-Pro-Quiz'); ?></h4>
    ...
    private function postBoxTitle()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz title', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(required)',
                    'Bestwebsite-Pro-Quiz'); ?></h3>
    ...
    private function postBoxCategory()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Category', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(optional)',
                    'Bestwebsite-Pro-Quiz'); ?></h3>

            <div class="inside">
                <p class="description">
                    <?php _e('You can assign classify category for a quiz.', 'Bestwebsite-Pro-Quiz'); ?>
                </p>

                <p class="description">
                    <?php _e('You can manage categories in global settings.', 'Bestwebsite-Pro-Quiz'); ?>
                </p>

                <div>
                    <select name="category">
                        <option value="-1">--- <?php _e('Create new category', 'Bestwebsite-Pro-Quiz'); ?>----
                        </option>
                        <option
                                value="0" <?php echo $this->quiz->getCategoryId() == 0 ? 'selected="selected"' : ''; ?>>
                            --- <?php _e('No category', 'Bestwebsite-Pro-Quiz'); ?> ---
                        </option>
                        <?php
    ...
    private function postBoxQuizDescription()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz description', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(required)',
                    'Bestwebsite-Pro-Quiz'); ?></h3>

            <div class="inside">
                <p class="description">
                    <?php _e('This text will be displayed before start of the quiz.', 'Bestwebsite-Pro-Quiz'); ?>
                </p>
                <?php
    ...
    private function postBoxResultOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Result-Options', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show average points', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show average points', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <p class="description">
                                    <?php _e('Statistics-function must be enabled.', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>

                                <div class="wpProQuiz_demoBox">
                                    <a href="#"><?php _e('Demo', 'Bestwebsite-Pro-Quiz'); ?></a>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show category score', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show category score', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct questions - display', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct questions - display', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide quiz time - display', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide quiz time - display', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide score - display', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide score - display', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
    ...
    private function postBoxQuestionOptions()
    {
        ...
        <div class="postbox">
            <h3 class="hndle"><?php _e('Question-Options', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show points', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show points', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Number answers', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Number answers', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct- and incorrect message', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct- and incorrect message', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Correct and incorrect answer mark', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Correct and incorrect answer mark', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Force user to answer each question', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Force user to answer each question', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question position overview', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question position overview', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question numbering', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question numbering', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display category', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display category', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
    ...
    private function postBoxLeaderboardOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Leaderboard', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(optional)', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <p>
                    <?php _e('The leaderboard works independent from internal statistics function.', 'Bestwebsite-Pro-Quiz'); ?>
                </p>
                <table class="form-table">
                    <tbody id="toplistBox">
                    <tr>
                        <th scope="row">
                            <?php _e('Leaderboard', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Who can sign up to the list', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('insert automatically', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('display captcha', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                            ...
                            <p class="description" style="color: red;">
                                <?php _e('This option requires additional plugin:', 'Bestwebsite-Pro-Quiz'); ?>
                                <a href="http://wordpress.org/extend/plugins/really-simple-captcha/" target="_blank">Really
                                    Simple CAPTCHA</a>
                            </p>
                            <?php if ($this->captchaIsInstalled) { ?>
                                <p class="description" style="color: green;">
                                    <?php _e('Plugin has been detected.', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                            <?php } else { ?>
                                <p class="description" style="color: red;">
                                    <?php _e('Plugin is not installed.', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                            <?php } ?>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('How many entries should be displayed', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <div>
                                <label>
                                    ...
                                    <?php _e('Entries', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Automatically display leaderboard in quiz result', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <div style="margin-top: 6px;">
                                <?php _e('Where should leaderboard be displayed:', 'Bestwebsite-Pro-Quiz'); ?>
                                <label style="margin-right: 5px; margin-left: 5px;">
                                    <input type="radio" name="toplistDataShowIn"
                                           value="0" <?php echo ($this->quiz->getToplistDataShowIn() == 0) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('don\'t display', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="toplistDataShowIn"
                                           value="1" <?php echo ($this->quiz->getToplistDataShowIn() == 1) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('below the "result text"', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                                ...
                                <label>
                                    ...
                                    <?php _e('in a button', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
    ...
    private function postBoxQuizMode()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz-Mode', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(required)', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #A0A0A0;"
                    ...
                    <thead>
                    <tr>
                        <th style="width: 25%;"><?php _e('Normal', 'Bestwebsite-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Normal + Back-Button', 'Bestwebsite-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Check -> continue', 'Bestwebsite-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Questions below each other', 'Bestwebsite-Pro-Quiz'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td><label><input type="radio" name="quizModus"
                                    ...
                                    WpProQuiz_Model_Quiz::QUIZ_MODUS_CHECK); ?>> <?php _e('Activate', 'Bestwebsite-Pro-Quiz'); ?>
                            </label></td>
                        <td><label><input type="radio" name="quizModus"
                    ...
                    <tr>
                        ...
                        <td>
                            <?php _e('Allows to use the back button in a question.', 'Bestwebsite-Pro-Quiz'); ?>
                        </td>
                        <td>
                            <?php _e('Shows "right or wrong" after each question.', 'Bestwebsite-Pro-Quiz'); ?>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <?php _e('How many questions to be displayed on a page:', 'Bestwebsite-Pro-Quiz'); ?><br>
                            <input type="number" name="questionsPerPage"
                                   value="<?php echo $this->quiz->getQuestionsPerPage(); ?>" min="0">
									<span class="description">
										<?php _e('(0 = All on one page)', 'Bestwebsite-Pro-Quiz'); ?>
									</span>
                        </td>
                    </tr>
                    </tbody>
    ...
    private function postBoxForms()
    {
        ...
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Custom fields', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <p class="description">
                    <?php _e('The statistic function have to be enabled.', 'Bestwebsite-Pro-Quiz'); ?>
                </p>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Custom fields enable', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Custom fields enable', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                ...
                                <p class="description">
                                    <?php _e('If you enable this option, custom fields are enabled.', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Display position', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display position', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <?php _e('Where should the fileds be displayed:', 'Bestwebsite-Pro-Quiz'); ?>
                                <label>
                                    <input type="radio"
                                    ...
                                    <?php _e('On the quiz startpage', 'Bestwebsite-Pro-Quiz'); ?>
                                ...
                                <label>
                                    ...
                                    <?php _e('At the end of the quiz (before the quiz result)', 'Bestwebsite-Pro-Quiz'); ?>
                ...
                <div style="margin-top: 10px; padding: 10px; border: 1px solid #C2C2C2;">
                    <table style=" width: 100%; text-align: left; " id="form_table">
                        ...
                        <tr>
                            <th>#ID</th>
                            <th><?php _e('Field name', 'Bestwebsite-Pro-Quiz'); ?></th>
                            <th><?php _e('Type', 'Bestwebsite-Pro-Quiz'); ?></th>
                            <th><?php _e('Required?', 'Bestwebsite-Pro-Quiz'); ?></th>
                            <th>
                                <?php _e('Show in statistic table?', 'Bestwebsite-Pro-Quiz'); ?>
                                <div style="display: inline-block;" class="wpProQuiz_demoBox">
                                    <a href="#"><?php _e('Demo', 'Bestwebsite-Pro-Quiz'); ?></a>
                        ...
                        <?php foreach ($forms as $form) {
                            ...
                            <tr <?php echo $index++ == 0 ? 'style="display: none;"' : '' ?>>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <a href="#" class="editDropDown"><?php _e('Edit list', 'Bestwebsite-Pro-Quiz'); ?></a>
                                    ...
                                    <div class="dropDownEditBox"
                                        ...
                                        <h4><?php _e('One entry per line', 'Bestwebsite-Pro-Quiz'); ?></h4>
                                        ...
                                        <input type="button" value="<?php _e('OK', 'Bestwebsite-Pro-Quiz'); ?>"
                                               class="button-primary">
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="button" name="form_delete"
                                           value="<?php _e('Delete', 'Bestwebsite-Pro-Quiz'); ?>" class="button-secondary">
                                    <a class="form_move button-secondary" href="#" style="cursor:move;"><?php _e('Move',
                                            'Bestwebsite-Pro-Quiz'); ?></a>
                    ...
                    <div style="margin-top: 10px;">
                        <input type="button" name="form_add" id="form_add"
                               value="<?php _e('Add field', 'Bestwebsite-Pro-Quiz'); ?>" class="button-secondary">
                    </div>
                </div>
            </div>
        </div>
    ...
    private function postBoxAdminEmailOption()
    {
        ...
        <div class="postbox" id="adminEmailSettings">
            <h3 class="hndle"><?php _e('Admin e-mail settings', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('To:', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('From:', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                            ...
                            <!-- 								<p class="description"> -->
                            <?php //_e('Server-Adresse empfohlen, z.B. info@YOUR-PAGE.com', 'Bestwebsite-Pro-Quiz');
                            ?>
                            <!-- 								</p> -->
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Subject:', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('HTML', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Message body:', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <?php
                            ...
                            <div style="padding-top: 10px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <th style="padding: 0;">
                                            <?php _e('Allowed variables', 'Bestwebsite-Pro-Quiz'); ?>
                                        </th>
                                        <th style="padding: 0;">
                                            <?php _e('Custom fields - Variables', 'Bestwebsite-Pro-Quiz'); ?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td style="vertical-align: top;">
                                            <ul>
                                                <li><span>$userId</span> - <?php _e('User-ID', 'Bestwebsite-Pro-Quiz'); ?></li>
                                                <li><span>$username</span> - <?php _e('Username', 'Bestwebsite-Pro-Quiz'); ?>
                                                </li>
                                                <li><span>$quizname</span> - <?php _e('Quiz-Name', 'Bestwebsite-Pro-Quiz'); ?>
                                                </li>
                                                <li><span>$result</span> - <?php _e('Result in precent',
                                                        'Bestwebsite-Pro-Quiz'); ?></li>
                                                <li><span>$points</span> - <?php _e('Reached points', 'Bestwebsite-Pro-Quiz'); ?>
                                                </li>
    ...
    private function postBoxUserEmailOption()
    {
        ...
        <div class="postbox" id="userEmailSettings">
            <h3 class="hndle"><?php _e('User e-mail settings', 'Bestwebsite-Pro-Quiz'); ?></h3>
