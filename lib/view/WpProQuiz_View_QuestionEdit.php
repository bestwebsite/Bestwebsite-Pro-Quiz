...
class WpProQuiz_View_QuestionEdit extends WpProQuiz_View_View
{
    public function show()
    {
		...
		<input type="hidden" value="<?php echo $this->question->getId(); ?>" name="questionId">-->
                <div id="poststuff">
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Title', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(optional)',
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(required)',
                                'Bestwebsite-Pro-Quiz'); ?></h3>

                        <div class="inside">
                            <div>
                                <p class="description">
                                    <?php _e('Points for this question (Standard is 1 point)', 'Bestwebsite-Pro-Quiz'); ?>
                                </p>
                                <label>
                                    <input name="points" class="small-text"
                                           value="<?php echo $this->question->getPoints(); ?>" type="number"
                                           min="1"> <?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                            ...
                            <div style="margin-top: 10px;">
                                <label>
                                    ...
                                    <?php _e('Different points for each answer', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Question', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(required)',
                                'Bestwebsite-Pro-Quiz'); ?></h3>
                            ...
                            <div class="inside">
                                ...
                                <div style="padding-top: 10px; padding-bottom: 10px;">
                                    <label for="wpProQuiz_correctSameText">
                                        <?php _e('Same text for correct- and incorrect-message?', 'Bestwebsite-Pro-Quiz'); ?>
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Hint', 'Bestwebsite-Pro-Quiz'); ?><?php _e('(optional)',
                                'Bestwebsite-Pro-Quiz'); ?></h3>

                        <div class="inside">
                            <p class="description">
                                <?php _e('Here you can enter solution hint.', 'Bestwebsite-Pro-Quiz'); ?>
                            </p>

                            <div style="padding-top: 10px; padding-bottom: 10px;">
                                <label for="wpProQuiz_tip">
                                    <?php _e('Activate hint for this question?', 'Bestwebsite-Pro-Quiz'); ?>
                    ...
                    <div class="postbox">
                        <h3 class="hndle"><?php _e('Answer type', 'Bestwebsite-Pro-Quiz'); ?></h3>
                        ...
                        <div class="inside answer_felder">
                            ...
                            <div class="sort_answer">
                                ...
                                <input type="button" class="button-primary addAnswer"
                                       value="<?php _e('Add new answer', 'Bestwebsite-Pro-Quiz'); ?>">
                            </div>
                            ...
                            <div class="matrix_sort_answer">
                                ...
                                <br>
                                <label>
                                    <?php _e('Percentage width of criteria table column:', 'Bestwebsite-Pro-Quiz'); ?>
            ...
            <li style="border-bottom:1px dotted #ccc; padding-bottom: 5px; background-color: whiteSmoke;" id="TEST">
                <table style="width: 100%;border: 1px solid #9E9E9E;border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tr>
                        ...
                        <th style="padding: 5px;"><?php _e('Answer', 'Bestwebsite-Pro-Quiz'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="border-right: 1px solid #9E9E9E; padding: 5px; vertical-align: top;">
                            ...
                            <div style="padding-top: 5px;">
                                <label>
                                    ...
                                    <?php _e('Allow HTML', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                            </div>
                            <div style="padding-top: 5px;" class="wpProQuiz_answerPoints">
                                <label>
                                    ...
                                    <?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?>
                                </label>
                            </div>
                        </td>
                ...
                <input type="button" name="submit" class="button-primary deleteAnswer"
                       value="<?php _e('Delete answer', 'Bestwebsite-Pro-Quiz'); ?>">
                ...
                <table style="width: 100%;border: 1px solid #9E9E9E;border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tr>
                        ...
                        <th style=" border-right: 1px solid #9E9E9E; padding: 5px; "><?php _e('Criterion',
                                'Bestwebsite-Pro-Quiz'); ?></th>
                        <th style="padding: 5px;"><?php _e('Sort elements', 'Bestwebsite-Pro-Quiz'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
    ...
    private function freeChoice($data)
    {
        ...
        <div class="answerList">
            <p class="description">
                <?php _e('correct answers (one per line) (answers will be converted to lower case)', 'Bestwebsite-Pro-Quiz'); ?>
            </p>
    ...
    private function assessmentChoice($data)
    {
        ...
        ?>
        <p class="description">
            <?php _e('Here you can create an assessment question.', 'Bestwebsite-Pro-Quiz'); ?>
        </p>
        <p class="description">
            <?php _e('Enclose a assesment with {}. The individual assessments are marked with [].', 'Bestwebsite-Pro-Quiz'); ?>
            <br>
            <?php _e('The number of options in the maximum score.', 'Bestwebsite-Pro-Quiz'); ?>
        </p>
        <p>
            <?php _e('Examples:', 'Bestwebsite-Pro-Quiz'); ?>
            <br>
            * <?php _e('less true { [1] [2] [3] [4] [5] } more true', 'Bestwebsite-Pro-Quiz'); ?>
        </p>
        ...
        <p>
            * <?php _e('less true { [a] [b] [c] } more true', 'Bestwebsite-Pro-Quiz'); ?>
        </p>
        <div class="wpProQuiz_demoImgBox">
            <a href="#"><?php _e('Demo', 'Bestwebsite-Pro-Quiz'); ?></a>
    ...
    private function singleChoiceOptions()
    {
        ...
        <div class="postbox" id="singleChoiceOptions">
            <h3 class="hndle"><?php _e('Single choice options', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <label>
                    ...
                    <?php _e('Different points - modus 2 activate', 'Bestwebsite-Pro-Quiz'); ?>
                </label>
                <br><br>

                <p class="description">
                    <?php _e('Disables the distinction between correct and incorrect.', 'Bestwebsite-Pro-Quiz'); ?><br>
                </p>
                <label>
                    <input type="checkbox" name=disableCorrect
                           value="1" <?php $this->checked($this->question->isDisableCorrect()); ?>>
                    <?php _e('disable correct and incorrent', 'Bestwebsite-Pro-Quiz'); ?>
                </label>

                <div style="padding-top: 20px;">
                    <a href="#" id="clickPointDia"><?php _e('Explanation of points calculation', 'Bestwebsite-Pro-Quiz'); ?></a>
        ...
        <table style="border-collapse: collapse; display: none; margin-top: 10px;" class="pointDia">
            <tr>
                <th>
                    ...
                    <br>
                    <?php _e('"Different points - mode 2" disable', 'Bestwebsite-Pro-Quiz'); ?>
                </th>
                <th>
                    <?php _e('"Different points for each answer" enabled'); ?>
                    <br>
                    <?php _e('"Different points - mode 2" enabled', 'Bestwebsite-Pro-Quiz'); ?>
                </th>
            </tr>
            <tr>
                <td>
