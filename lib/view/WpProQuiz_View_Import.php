...
class WpProQuiz_View_Import extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_importOverall">
            <h2><?php _e('Import', 'Bestwebsite-Pro-Quiz'); ?></h2>
            ...
            <?php if ($this->error) { ?>
                <div style="padding: 10px; background-color: rgb(255, 199, 199); margin-top: 20px; border: 1px dotted;">
                    <h3 style="margin-top: 0;"><?php _e('Error', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <?php } else {
                if ($this->finish) { ?>
                    <div style="padding: 10px; background-color: #C7E4FF; margin-top: 20px; border: 1px dotted;">
                        <h3 style="margin-top: 0;"><?php _e('Successfully', 'Bestwebsite-Pro-Quiz'); ?></h3>

                        <div>
                            <?php _e('Import completed successfully', 'Bestwebsite-Pro-Quiz'); ?>
                        </div>
                    </div>
                <?php } else { ?>
                    <form method="post">
                        <table class="wp-list-table widefat">
                            ...
                            <tr>
                                ...
                                <th scope="col" width="40%"><?php _e('Quiz name', 'Bestwebsite-Pro-Quiz'); ?></th>
                                <th scope="col"><?php _e('Questions', 'Bestwebsite-Pro-Quiz'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                        ...
                        <input style="margin-top: 20px;" class="button-primary" name="importSave"
                               value="<?php echo __('Start import', 'Bestwebsite-Pro-Quiz'); ?>" type="submit">
                    </form>
                <?php }
            } ?>
        </div>
