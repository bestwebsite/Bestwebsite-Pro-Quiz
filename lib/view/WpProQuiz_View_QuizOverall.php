...
class WpProQuiz_View_QuizOverall extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_quizOverall" style="">
            <h2>
                <?php _e('Quiz overview', 'Bestwebsite-Pro-Quiz'); ?>
            ...
            <p style="margin-bottom: 0; display: none;">
                ...
                <?php }
                if (current_user_can('wpProQuiz_import')) { ?>
                    <a class="button-secondary wpProQuiz_import" href="#"><?php echo __('Import', 'Bestwebsite-Pro-Quiz'); ?></a>
                <?php } ?>
            </p>
        ...
        <div id="wpProQuiz_importList_box" style="display: none;">
            <div class="wpProQuiz_importList">
                <form action="admin.php?page=wpProQuiz&module=importExport&action=import" method="POST"
                    ...
                    <p><?php echo sprintf(__('Supported formats: %s', 'Bestwebsite-Pro-Quiz'), implode(', ', $this->supportedImportFormats['extensions'])) ?></p>
        ...
        <div id="wpProQuiz_setQuizCategoryList_box" style="display: none;">
            <div class="wpProQuiz_setQuizCategoryList">
                <form action="#" method="POST">
                    <h3 style="margin-top: 0;"><?php _e('Set Quiz Categories', 'Bestwebsite-Pro-Quiz'); ?></h3>

                    <p><?php _e('Sets multiple quiz categories ', 'Bestwebsite-Pro-Quiz'); ?></p>
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <div>
                            <select name="category">
                                ...
                                <option value="0" selected="selected">--- <?php _e('No category', 'Bestwebsite-Pro-Quiz'); ?>
                                    ---
                                </option>
                                <?php
                    ...
                    <input class="button-primary" name="setCategoriesStart" id="setCategoriesStart"
                           value="<?php _e('Save', 'Bestwebsite-Pro-Quiz'); ?>" type="button">
