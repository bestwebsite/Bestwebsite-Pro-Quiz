...
class WpProQuiz_View_GobalSettings extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_globalSettings">
            <h2 style="margin-bottom: 10px;"><?php _e('Global settings', 'Bestwebsite-Pro-Quiz'); ?></h2>

            <div class="nav-tab-wrapper wpProQuiz-top-tab-wrapper">
                <a href="#globalContent" data-tab="globalContent" class="nav-tab nav-tab-active"><?php _e('Global settings', 'Bestwebsite-Pro-Quiz'); ?></a>
                <a href="#problemContent" data-tab="problemContent" class="nav-tab "><?php _e('Settings in case of problems', 'Bestwebsite-Pro-Quiz'); ?></a>
            </div>
    ...
    private function globalSettings()
    {
        ...
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Global settings', 'Bestwebsite-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Leaderboard time format', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Leaderboard time format', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                ...
                                <label>
                                    ...
                                    <?php _e('Custom', 'Bestwebsite-Pro-Quiz'); ?>:
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Statistic time format', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistic time format', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>

                                <label>
                                    <?php _e('Select example:', 'Bestwebsite-Pro-Quiz'); ?>
                                ...
                                <div style="margin-top: 10px;">
                                    <label>
                                        <?php _e('Time format:', 'Bestwebsite-Pro-Quiz'); ?>:
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Category management', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Category management', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                ...
                                <div style="padding-top: 5px;">
                                    <input type="button" value="<?php _e('Delete', 'Bestwebsite-Pro-Quiz'); ?>"
                                           name="categoryDelete" class="button-secondary">
                                    <input type="button" value="<?php _e('Edit', 'Bestwebsite-Pro-Quiz'); ?>" name="categoryEdit"
                    ...
                    <tr>
                        ...
                        <th scope="row">
                            <?php _e('Quiz Category management', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Quiz Category management', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                                ...
                                <div style="padding-top: 5px;">
                                    ...
                                    <input type="button" value="<?php _e('Edit', 'Bestwebsite-Pro-Quiz'); ?>"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Quiz template management', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Quiz template management', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Question template management', 'Bestwebsite-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Question template management', 'Bestwebsite-Pro-Quiz'); ?></span>
                                </legend>
    ...
    {
        if ($this->isRaw) {
            $rawSystem = __('to activate', 'Bestwebsite-Pro-Quiz');
        } else {
            $rawSystem = __('not to activate', 'Bestwebsite-Pro-Quiz');
        }

        ?>

        <div class="updated" id="problemInfo" style="display: none;">
            <h3><?php _e('Please note', 'Bestwebsite-Pro-Quiz'); ?></h3>

            <p>
                <?php _e('These settings should only be set in cases of problems with Bestwebsite-Pro-Quiz.', 'Bestwebsite-Pro-Quiz'); ?>
            </p>
        </div>

        <h3 class="hndle"><?php _e('Settings in case of problems', 'Bestwebsite-Pro-Quiz'); ?></h3>
        <div class="inside">
            <table class="form-table">
                <tbody>
                <tr>
                    <th scope="row">
                        <?php _e('Automatically add [raw] shortcode', 'Bestwebsite-Pro-Quiz'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Automatically add [raw] shortcode', 'Bestwebsite-Pro-Quiz'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                                       name="addRawShortcode" <?php echo $this->settings->isAddRawShortcode() ? 'checked="checked"' : '' ?> >
                                <?php _e('Activate', 'Bestwebsite-Pro-Quiz'); ?> <span
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Do not load the Javascript-files in the footer', 'Bestwebsite-Pro-Quiz'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                            ...
                            <p class="description">
                                <?php _e('In very old Wordpress themes this can lead to problems.', 'Bestwebsite-Pro-Quiz'); ?>
                            </p>
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Touch Library', 'Bestwebsite-Pro-Quiz'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Touch Library', 'Bestwebsite-Pro-Quiz'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                ...
                <tr>
                    <th scope="row">
                        <?php _e('jQuery support cors', 'Bestwebsite-Pro-Quiz'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('jQuery support cors', 'Bestwebsite-Pro-Quiz'); ?></span>
                            </legend>
                            <label>
                                <input type="checkbox" value="1"
                            ...
                            <p class="description">
                                <?php _e('Is required only in rare cases.', 'Bestwebsite-Pro-Quiz'); ?>
                            </p>
                ...
                <tr>
                    <th scope="row">
                        <?php _e('Repair database', 'Bestwebsite-Pro-Quiz'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Repair database', 'Bestwebsite-Pro-Quiz'); ?></span>
                            </legend>
                            <input type="submit" name="databaseFix" class="button-primary"
                                   value="<?php _e('Repair database', 'Bestwebsite-Pro-Quiz'); ?>">

                            <p class="description">
                                <?php _e('No date will be deleted. Only Bestwebsite-Pro-Quiz tables will be repaired.',
                                    'Bestwebsite-Pro-Quiz'); ?>
                            </p>
                        </fieldset>
                    </td>
