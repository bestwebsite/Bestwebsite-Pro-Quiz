...
class WpProQuiz_View_QuestionImportPreview extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_importOverall">
            ...
            <p>
                <a class="button-secondary" href="<?php admin_url('admin.php?page=wpProQuiz&module=question&quiz_id='.$this->quizId); ?>"><?php _e('back to overview', 'Bestwebsite-Pro-Quiz'); ?></a>
            </p>
            ...
            <form method="post" action="<?php echo admin_url('admin.php?page=wpProQuiz&module=questionImport&action=import&quizId='.$this->quizId); ?>">
                ...
                <input style="margin-top: 20px;" class="button-primary" name="importSave" value="<?php echo __('Start import', 'Bestwebsite-Pro-Quiz'); ?>" type="submit">
            </form>
        </div>
