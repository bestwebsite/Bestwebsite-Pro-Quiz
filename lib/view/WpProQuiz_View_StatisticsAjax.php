...
class WpProQuiz_View_StatisticsAjax extends WpProQuiz_View_View
{
    ...
    public function showHistoryTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr>
                <th scope="col"><?php _e('Username', 'Bestwebsite-Pro-Quiz'); ?></th>
                ...
                <th scope="col" style="width: 200px;"><?php _e('Date', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Solved', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Results', 'Bestwebsite-Pro-Quiz'); ?></th>
            </tr>
            </thead>
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $model->getQuizId(); ?>&user_id=0&ref_id=<?php echo $model->getStatisticRefId(); ?>&avg=0&noheader=true"><?php _e('Export', 'Bestwebsite-Pro-Quiz'); ?></a>
                                </span>
                            </div>
                        ...
                        <th><?php echo $model->getSolvedCount() < 0 ? '---' : sprintf(__('%d of %d', 'Bestwebsite-Pro-Quiz'),
    ...
    public function showUserTable()
    {
        ...
        <h2><?php printf(__('User statistics: %s', 'Bestwebsite-Pro-Quiz'), esc_html($this->userName)); ?></h2>
        <?php if ($this->avg) { ?>
        <h2>
    ...
    <?php } ?>
        ...
        <table class="wp-list-table widefat" style="margin-top: 20px;">
            ...
            <tr>
                ...
                <th scope="col"><?php _e('Question', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Hints used', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Solved', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Time', 'Bestwebsite-Pro-Quiz'); ?> <span
                        style="font-size: x-small;">(hh:mm:ss)</span></th>
                <th scope="col" style="width: 100px;"><?php _e('Points scored', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Results', 'Bestwebsite-Pro-Quiz'); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach ($this->userStatistic as $cat) {
                ...
                <tr class="categoryTr">
                    <th colspan="9">
                        <span><?php _e('Category', 'Bestwebsite-Pro-Quiz'); ?>:</span>
                ...
                <?php foreach ($cat['questions'] as $q) {
                    ...
                    <tr>
                        ...
                        <th><?php echo $q['solvedCount'] < 0 ? '---' : ($q['solvedCount'] ? __('yes',
                                'Bestwebsite-Pro-Quiz') : __('no', 'Bestwebsite-Pro-Quiz')); ?></th>
                ...
                <tr class="categoryTr" id="wpProQuiz_ctr_222">
                    <th colspan="2">
                        <span><?php _e('Sub-Total: ', 'Bestwebsite-Pro-Quiz'); ?></span>
                    </th>
                    ...
                    <th><?php echo $cSolvedCount < 0 ? '---' : sprintf(__('%d of %d', 'Bestwebsite-Pro-Quiz'), $cSolvedCount,
                            $sum); ?></th>
            ...
            <tr id="wpProQuiz_tr_0">
                <th></th>
                <th><?php _e('Total', 'Bestwebsite-Pro-Quiz'); ?></th>
                ...
                <th><?php echo $gSolvedCount < 0 ? '---' : sprintf(__('%d of %d', 'Bestwebsite-Pro-Quiz'), $gSolvedCount,
                        $sum); ?></th>
        ...
        <div style="margin-top: 10px;">
            <div style="float: left;">
                <a class="button-secondary wpProQuiz_update" href="#"><?php _e('Refresh', 'Bestwebsite-Pro-Quiz'); ?></a>
                <a class="button-secondary wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $this->userId; ?>&ref_id=<?php echo $this->refId; ?>&avg=<?php echo $this->avg; ?>&noheader=true"><?php _e('Export', 'Bestwebsite-Pro-Quiz'); ?></a>
            </div>
...
// 			$a .= '<span class="wpProQuiz_clozeCorrect" style="display: none;">('.implode(', ', $rowText).')</span></span>';
                                    ...
                                    <td>
                                        ...
                                        switch ($form->getType()) {
                                            ...
                                            case WpProQuiz_Model_Form::FORM_TYPE_CHECKBOX:
                                                echo $str == '1' ? __('ticked', 'Bestwebsite-Pro-Quiz') : __('not ticked',
    ...
    public function showOverviewTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr>
                <th scope="col"><?php _e('User', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'Bestwebsite-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Hints used', 'Bestwebsite-Pro-Quiz'); ?></th>
            ...
            <?php } else { ?>
                ...
                <?php foreach ($this->statisticModel as $model) {
                    ...
                    if (!$model->getUserId()) {
                        $model->setUserName(__('Anonymous', 'Bestwebsite-Pro-Quiz'));
                    }
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                |
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $model->getUserId(); ?>&ref_id=0&avg=1&noheader=true"><?php _e('Export', 'Bestwebsite-Pro-Quiz'); ?></a>
                                </span>
                            </div>
