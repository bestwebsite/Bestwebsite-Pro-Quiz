...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View
{
    ...
    private function loadButtonNames()
    {
        ...
        $names = array(
            'start_quiz' => __('Start quiz', 'Bestwebsite-Pro-Quiz'),
            'restart_quiz' => __('Restart quiz', 'Bestwebsite-Pro-Quiz'),
            'quiz_summary' => __('Quiz-summary', 'Bestwebsite-Pro-Quiz'),
            'finish_quiz' => __('Finish quiz', 'Bestwebsite-Pro-Quiz'),
            'quiz_is_loading' => __('Quiz is loading...', 'Bestwebsite-Pro-Quiz'),
            'lock_box_msg' => __('You have already completed the quiz before. Hence you can not start it again.',
                'Bestwebsite-Pro-Quiz'),
            'only_registered_user_msg' => __('You must sign in or sign up to start the quiz.', 'Bestwebsite-Pro-Quiz'),
            'prerequisite_msg' => __('You have to finish following quiz, to start this quiz:', 'Bestwebsite-Pro-Quiz')
        );
        ...
        <div class="wpProQuiz_addToplist" style="display: none;">
            ...
            <div style="margin-top: 6px;">
                <div class="wpProQuiz_addToplistMessage" style="display: none;"><?php _e('Loading',
                        'Bestwebsite-Pro-Quiz'); ?></div>
                <div class="wpProQuiz_addBox">
                    <div>
						<span>
							<label>
                                <?php _e('Name', 'Bestwebsite-Pro-Quiz'); ?>: <input type="text" placeholder="<?php _e('Name',
                                    'Bestwebsite-Pro-Quiz'); ?>" name="wpProQuiz_toplistName" maxlength="15" size="16"
                                                                            style="width: 150px;">
                            </label>
							<label>
                                <?php _e('E-Mail', 'Bestwebsite-Pro-Quiz'); ?>: <input type="email"
                        ...
                        <div style="margin-top: 5px;">
                            <label>
                                <?php _e('Captcha', 'Bestwebsite-Pro-Quiz'); ?>: <input type="text" name="wpProQuiz_captcha"
                    ...
                    <input class="wpProQuiz_button2" type="submit" value="<?php _e('Send', 'Bestwebsite-Pro-Quiz'); ?>"
    ...
    {
        $info = '<div class="wpProQuiz_invalidate">' . __('You must fill out this field.', 'Bestwebsite-Pro-Quiz') . '</div>';

        $validateText = array(
            WpProQuiz_Model_Form::FORM_TYPE_NUMBER => __('You must specify a number.', 'Bestwebsite-Pro-Quiz'),
            WpProQuiz_Model_Form::FORM_TYPE_TEXT => __('You must specify a text.', 'Bestwebsite-Pro-Quiz'),
            WpProQuiz_Model_Form::FORM_TYPE_EMAIL => __('You must specify an email address.', 'Bestwebsite-Pro-Quiz'),
            WpProQuiz_Model_Form::FORM_TYPE_DATE => __('You must specify a date.', 'Bestwebsite-Pro-Quiz')
        );
        ?>
                        ...
                        <td>
                            ...
                            switch ($form->getType()) {
                                ...
                                case WpProQuiz_Model_Form::FORM_TYPE_YES_NO:
                                    ...
                                    __('Yes', 'Bestwebsite-Pro-Quiz');
                                    echo '</label> ';

                                    echo '<label>';
                                    echo '<input name="' . $name . '" type="radio" value="0"> ',
                                    __('No', 'Bestwebsite-Pro-Quiz');
                                    echo '</label> ';
                                    echo '</div>';
                                    break;
                            }
    ...
    private function showCheckPageBox($questionCount)
    {
        ...
        <div class="wpProQuiz_checkPage" style="display: none;">
            ...
            <p>
                <?php printf(__('%s of %s questions completed', 'Bestwebsite-Pro-Quiz'), '<span>0</span>', $questionCount); ?>
            </p>

            <p><?php _e('Questions', 'Bestwebsite-Pro-Quiz'); ?>:</p>
            ...
            if ($this->quiz->isFormActivated() && $this->quiz->getFormShowPosition() == WpProQuiz_Model_Quiz::QUIZ_FORM_POSITION_END
                ...
                ?>
                <h4 class="wpProQuiz_header"><?php _e('Information', 'Bestwebsite-Pro-Quiz'); ?></h4>
                <?php
                $this->showFormBox();
            }
    ...
    private function showInfoPageBox()
    {
        ...
        <div class="wpProQuiz_infopage" style="display: none;">
            <h4><?php _e('Information', 'Bestwebsite-Pro-Quiz'); ?></h4>
    ...
    private function showTimeLimitBox()
    {
        ...
        <div style="display: none;" class="wpProQuiz_time_limit">
            <div class="time"><?php _e('Time limit', 'Bestwebsite-Pro-Quiz'); ?>: <span>0</span></div>
        ...
        <div class="wpProQuiz_reviewDiv" style="display: none;">
            ...
            <div class="wpProQuiz_reviewLegend">
                <ol>
                    <li>
                        ...
                        <span class="wpProQuiz_reviewText"><?php _e('Answered', 'Bestwebsite-Pro-Quiz'); ?></span>
                    </li>
                    <li>
                        <span class="wpProQuiz_reviewColor" style="background-color: #FFB800;"></span>
                        <span class="wpProQuiz_reviewText"><?php _e('Review', 'Bestwebsite-Pro-Quiz'); ?></span>
                    </li>
                </ol>
                <div style="clear: both;"></div>
            </div>
            <div>
                <?php if ($this->quiz->getQuizModus() != WpProQuiz_Model_Quiz::QUIZ_MODUS_SINGLE) { ?>
                    <input type="button" name="review" value="<?php _e('Review question', 'Bestwebsite-Pro-Quiz'); ?>"
    ...
    private function showResultBox($result, $questionCount)
    {
        ...
        <div style="display: none;" class="wpProQuiz_results">
            <h4 class="wpProQuiz_header"><?php _e('Results', 'Bestwebsite-Pro-Quiz'); ?></h4>
            <?php if (!$this->quiz->isHideResultCorrectQuestion()) { ?>
                <p>
                    <?php printf(__('%s of %s questions answered correctly', 'Bestwebsite-Pro-Quiz'),
                        '<span class="wpProQuiz_correct_answer">0</span>', '<span>' . $questionCount . '</span>'); ?>
                </p>
            <?php }
            if (!$this->quiz->isHideResultQuizTime()) { ?>
                <p class="wpProQuiz_quiz_time">
                    <?php _e('Your time: <span></span>', 'Bestwebsite-Pro-Quiz'); ?>
                </p>
            <?php } ?>
            <p class="wpProQuiz_time_limit_expired" style="display: none;">
                <?php _e('Time has elapsed', 'Bestwebsite-Pro-Quiz'); ?>
            </p>
            <?php if (!$this->quiz->isHideResultPoints()) { ?>
                <p class="wpProQuiz_points">
                    <?php printf(__('You have reached %s of %s points, (%s)', 'Bestwebsite-Pro-Quiz'), '<span>0</span>',
            ...
            <?php if ($this->quiz->isShowAverageResult()) { ?>
                <div class="wpProQuiz_resultTable">
                    <table>
                        <tbody>
                        <tr>
                            <td class="wpProQuiz_resultName"><?php _e('Average score', 'Bestwebsite-Pro-Quiz'); ?></td>
                        ...
                        <tr>
                            <td class="wpProQuiz_resultName"><?php _e('Your score', 'Bestwebsite-Pro-Quiz'); ?></td>
                            <td class="wpProQuiz_resultValue">
            ...
            <div class="wpProQuiz_catOverview" <?php $this->isDisplayNone($this->quiz->isShowCategoryScore()); ?>>
                <h4><?php _e('Categories', 'Bestwebsite-Pro-Quiz'); ?></h4>

                <div style="margin-top: 10px;">
                    <ol>
                        <?php foreach ($this->category as $cat) {
                            if (!$cat->getCategoryId()) {
                                $cat->setCategoryName(__('Not categorized', 'Bestwebsite-Pro-Quiz'));
                            }
                            ?>
            ...
            <div style="margin: 10px 0px;">
                ...
                if (!$this->quiz->isBtnViewQuestionHidden()) { ?>
                    <input class="wpProQuiz_button" type="button" name="reShowQuestion"
                           value="<?php _e('View questions', 'Bestwebsite-Pro-Quiz'); ?>">
                <?php } ?>
                <?php if ($this->quiz->isToplistActivated() && $this->quiz->getToplistDataShowIn() == WpProQuiz_Model_Quiz::QUIZ_TOPLIST_SHOW_IN_BUTTON) { ?>
                    <input class="wpProQuiz_button" type="button" name="showToplist"
                           value="<?php _e('Show leaderboard', 'Bestwebsite-Pro-Quiz'); ?>">
                <?php } ?>
            </div>
        </div>
        <?php
                ...
                foreach ($this->question as $question) {
                    ...
                    <li class="wpProQuiz_listItem" style="display: none;">
                        <div
                            ...
                            <?php printf(__('Question %s of %s', 'Bestwebsite-Pro-Quiz'), '<span>' . $index . '</span>',
                                '<span>' . $questionCount . '</span>'); ?>
                        </div>
                        <h5 style="<?php echo $this->quiz->isHideQuestionNumbering() ? 'display: none;' : 'display: inline-block;' ?>"
                            class="wpProQuiz_header">
                            <span><?php echo $index; ?></span>. <?php _e('Question', 'Bestwebsite-Pro-Quiz'); ?>
                        </h5>

                        <?php if ($this->quiz->isShowPoints()) { ?>
                            <span style="font-weight: bold; float: right;"><?php printf(__('%d points', 'Bestwebsite-Pro-Quiz'),
                        ...
                        <?php if ($question->getCategoryId() && $this->quiz->isShowCategory()) { ?>
                            <div style="font-weight: bold; padding-top: 5px;">
                                <?php printf(__('Category: %s', 'Bestwebsite-Pro-Quiz'),
                        ...
                        <div class="wpProQuiz_question" style="margin: 10px 0 0 0;">
                            ...
                            <?php if ($question->getAnswerType() === 'matrix_sort_answer') { ?>
                                <div class="wpProQuiz_matrixSortString">
                                    <h5 class="wpProQuiz_header"><?php _e('Sort elements', 'Bestwebsite-Pro-Quiz'); ?></h5>
                            ...
                            <div class="wpProQuiz_response" style="display: none;">
                                <div style="display: none;" class="wpProQuiz_correct">
									...
									<span style="float: left;" class="wpProQuiz_respone_span">
										<?php _e('Correct', 'Bestwebsite-Pro-Quiz'); ?>
									</span>
                                            <span
                                ...
                                <div style="display: none;" class="wpProQuiz_incorrect">
                                    <?php if ($question->isShowPointsInBox() && $question->isAnswerPointsActivated()) { ?>
                                        <div>
									<span style="float: left;" class="wpProQuiz_respone_span">
										<?php _e('Incorrect', 'Bestwebsite-Pro-Quiz'); ?>
									</span>
                        ...
                        <?php if ($this->quiz->getQuizModus() == WpProQuiz_Model_Quiz::QUIZ_MODUS_CHECK && !$this->quiz->isSkipQuestionDisabled() && $this->quiz->isShowReviewQuestion()) { ?>
                            <input type="button" name="skip" value="<?php _e('Skip question', 'Bestwebsite-Pro-Quiz'); ?>"
                                   class="wpProQuiz_button wpProQuiz_QuestionButton"
                                   style="float: left; margin-right: 10px !important;">
                        <?php } ?>
                        <input type="button" name="back" value="<?php _e('Back', 'Bestwebsite-Pro-Quiz'); ?>"
                               class="wpProQuiz_button wpProQuiz_QuestionButton"
                               style="float: left !important; margin-right: 10px !important; display: none;">
                        <?php if ($question->isTipEnabled()) { ?>
                            <input type="button" name="tip" value="<?php _e('Hint', 'Bestwebsite-Pro-Quiz'); ?>"
                        ...
                        <?php } ?>
                        <input type="button" name="check" value="<?php _e('Check', 'Bestwebsite-Pro-Quiz'); ?>"
                               class="wpProQuiz_button wpProQuiz_QuestionButton"
                               style="float: right !important; margin-right: 10px !important; display: none;">
                        <input type="button" name="next" value="<?php _e('Next', 'Bestwebsite-Pro-Quiz'); ?>"
            ...
            <?php if ($this->quiz->getQuizModus() == WpProQuiz_Model_Quiz::QUIZ_MODUS_SINGLE) { ?>
                <div>
                    <input type="button" name="wpProQuiz_pageLeft"
                           data-text="<?php echo esc_attr(__('Page %d', 'Bestwebsite-Pro-Quiz')); ?>"
