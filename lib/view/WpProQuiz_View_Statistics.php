...
class WpProQuiz_View_Statistics extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_statistics">
            ...
            <h2><?php printf(__('Quiz: %s - Statistics', 'Bestwebsite-Pro-Quiz'), $this->quiz->getName()); ?></h2>

            <p><a class="button-secondary" href="admin.php?page=wpProQuiz"><?php _e('back to overview',
                        'Bestwebsite-Pro-Quiz'); ?></a></p>
            ...
            <div id="wpProQuiz_loadData" class="wpProQuiz_blueBox" style="background-color: #F8F5A8; display: none;">
                ...
                <?php _e('Loading', 'Bestwebsite-Pro-Quiz'); ?>
            </div>
            ...
            <div class="wpProQuiz_blueBox" id="wpProQuiz_userBox" style="margin-bottom: 20px;">
                <div style="float: left;">
                    <div style="padding-top: 6px;">
                        <?php _e('Please select user name:', 'Bestwebsite-Pro-Quiz'); ?>
                    </div>

                    <div style="padding-top: 6px;">
                        <?php _e('Select a test:', 'Bestwebsite-Pro-Quiz'); ?>
                    </div>
                ...
                <div style="float: left;">
                    <div>
                        <select name="userSelect" id="userSelect">
                            <?php foreach ($this->users as $user) {
                                if ($user->ID == 0) {
                                    echo '<option value="0">=== ', __('Anonymous user', 'Bestwebsite-Pro-Quiz'), ' ===</option>';
                                } else {
                    ...
                    <div>
                        <select id="testSelect">
                            <option value="0">=== <?php _e('average', 'Bestwebsite-Pro-Quiz'); ?> ===</option>
                        </select>
                    </div>
                </div>
    ...
    private function tabOverview()
    {
        ...
        <div id="wpProQuiz_tabOverview" class="wpProQuiz_tabContent" style="display: none;">
            ...
            <div id="poststuff">
                <div class="postbox">
                    <h3 class="hndle"><?php _e('Filter', 'Bestwebsite-Pro-Quiz'); ?></h3>

                    <div class="inside">
                        <ul>
                            <li>
                                <label>
                                    <?php _e('Show only users, who solved the quiz:', 'Bestwebsite-Pro-Quiz'); ?>
                                    <input type="checkbox" value="1" id="wpProQuiz_onlyCompleted">
                                </label>
                            </li>
                            <li>
                                <label>
                                    <?php _e('How many entries should be shown on one page:', 'Bestwebsite-Pro-Quiz'); ?>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <ul>
                            <li>
                                <label>
                                    <?php _e('Which users should be displayed:', 'Bestwebsite-Pro-Quiz'); ?>
                                    <select id="wpProQuiz_formUser">
                                        <option value="0"><?php _e('all', 'Bestwebsite-Pro-Quiz'); ?></option>
                                        <option value="1"><?php _e('only registered users', 'Bestwebsite-Pro-Quiz'); ?></option>
                                        <option value="2"><?php _e('only anonymous users', 'Bestwebsite-Pro-Quiz'); ?></option>
                                    </select>
                                </label>
                            </li>
                            <li>
