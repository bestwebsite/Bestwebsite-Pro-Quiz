...
class WpProQuiz_Controller_Quiz extends WpProQuiz_Controller_Controller
{
    ...
    private function showActionHook()
    {
        ...
        add_screen_option('per_page', array(
            'label' => __('Quiz', 'Bestwebsite-Pro-Quiz'),
            'default' => 20,
    ...
    private function addEditQuiz()
    {
        ...
        if ($quizId && $quizMapper->exists($quizId) == 0) {
            WpProQuiz_View_View::admin_notices(__('Quiz not found', 'Bestwebsite-Pro-Quiz'), 'error');
        ...
        if (isset($this->_post['template']) || (isset($this->_post['templateLoad']) && isset($this->_post['templateLoadId']))) {
            ...
            if (isset($this->_post['submit'])) {
                ...
                if ($this->checkValidit($this->_post)) {
                    if ($quizId) {
                        WpProQuiz_View_View::admin_notices(__('Quiz edited', 'Bestwebsite-Pro-Quiz'), 'info');
                    } else {
                        WpProQuiz_View_View::admin_notices(__('quiz created', 'Bestwebsite-Pro-Quiz'), 'info');
                    }
        ...
        $view->header = $quizId ? __('Edit quiz', 'Bestwebsite-Pro-Quiz') : __('Create quiz', 'Bestwebsite-Pro-Quiz');
...
//        }
    ...
    private function saveTemplate()
    {
        ...
        WpProQuiz_View_View::admin_notices(__('Template stored', 'Bestwebsite-Pro-Quiz'), 'info');
    ...
    private function deleteAction($id)
    {
        ...
        WpProQuiz_View_View::admin_notices(__('Quiz deleted', 'Bestwebsite-Pro-Quiz'), 'info');
    ...
    private function setCategoryOverview($catArray, $categories)
    {
        ...
        $a = __('Categories', 'Bestwebsite-Pro-Quiz') . ":\n";
