...
class WpProQuiz_Controller_Admin
{
    ...
    private function localizeScript()
    {
        ...
        $translation_array = array(
            'delete_msg' => __('Do you really want to delete the quiz/question?', 'Bestwebsite-Pro-Quiz'),
            'no_title_msg' => __('Title is not filled!', 'Bestwebsite-Pro-Quiz'),
            'no_question_msg' => __('No question deposited!', 'Bestwebsite-Pro-Quiz'),
            'no_correct_msg' => __('Correct answer was not selected!', 'Bestwebsite-Pro-Quiz'),
            'no_answer_msg' => __('No answer deposited!', 'Bestwebsite-Pro-Quiz'),
            'no_quiz_start_msg' => __('No quiz description filled!', 'Bestwebsite-Pro-Quiz'),
            'fail_grade_result' => __('The percent values in result text are incorrect.', 'Bestwebsite-Pro-Quiz'),
            'no_nummber_points' => __('No number in the field "Points" or less than 1', 'Bestwebsite-Pro-Quiz'),
            'no_nummber_points_new' => __('No number in the field "Points" or less than 0', 'Bestwebsite-Pro-Quiz'),
            'no_selected_quiz' => __('No quiz selected', 'Bestwebsite-Pro-Quiz'),
            'reset_statistics_msg' => __('Do you really want to reset the statistic?', 'Bestwebsite-Pro-Quiz'),
            'no_data_available' => __('No data available', 'Bestwebsite-Pro-Quiz'),
            'no_sort_element_criterion' => __('No sort element in the criterion', 'Bestwebsite-Pro-Quiz'),
            'dif_points' => __('"Different points for every answer" is not possible at "Free" choice', 'Bestwebsite-Pro-Quiz'),
            'category_no_name' => __('You must specify a name.', 'Bestwebsite-Pro-Quiz'),
            'confirm_delete_entry' => __('This entry should really be deleted?', 'Bestwebsite-Pro-Quiz'),
            'not_all_fields_completed' => __('Not all fields completed.', 'Bestwebsite-Pro-Quiz'),
            'temploate_no_name' => __('You must specify a template name.', 'Bestwebsite-Pro-Quiz'),
            'closeText' => __('Close', 'Bestwebsite-Pro-Quiz'),
            'currentText' => __('Today', 'Bestwebsite-Pro-Quiz'),
...
//			'dateFormat'        => WpProQuiz_Helper_Until::convertPHPDateFormatToJS(get_option('date_format', 'm/d/Y')),
    ...
    public function register_page()
    {
        ...
        $pages[] = add_submenu_page(
            'wpProQuiz',
            __('Global settings', 'Bestwebsite-Pro-Quiz'),
            __('Global settings', 'Bestwebsite-Pro-Quiz'),
        ...
        $pages[] = add_submenu_page(
            'wpProQuiz',
            __('Support & More', 'Bestwebsite-Pro-Quiz'),
            __('Support & More', 'Bestwebsite-Pro-Quiz'),
            'wpProQuiz_show',
