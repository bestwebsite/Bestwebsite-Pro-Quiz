...
class WpProQuiz_Plugin_BpAchievementsV2
{
    ...
    public function setCategoryName($category_name, $category)
    {
        ...
        if (__($other, 'dpa') == $category_name && 'Bestwebsite-Pro-Quiz' == $category) {
            return 'Bestwebsite-Pro-Quiz';
        } else {
    ...
    public static function install()
    {
        ...
        $actions = array(
            array(
                'category' => 'Bestwebsite-Pro-Quiz',
                'name' => 'wp_pro_quiz_quiz_finished',
                'description' => __('The user completed a quiz.', 'Bestwebsite-Pro-Quiz')
            )
        );
